...
/**
* @preserve
* ForeSee Gateway Script v2.3.6. Wednesday, April 18th, 2018, 5:51:51 PM
...
productConfig.feedback = ({
  ...
  "check": function () {
    ...
    var config = {};
    config = {"instances":[{"devices":{"overridesEnabled":true,"desktop":{"icon":"aspark100.png","fbtype":"badge","surveytype":"modal","fbsize":"small","fbdirection":"vertical","label":"Feedback","fbcolor":"#000","fblocation":"middleright","fbfixed":false,"fbanimate":true},"mobile":{"icon":"aspark100.png","fbtype":"badge","surveytype":"popup","fbsize":"small","fblocation":"middleright","label":"Feedback","fbanimate":false},"tablet":{"icon":"aspark100.png","fbtype":"badge","fbdirection":"vertical","fblocation":"middleright","label":"Feedback","popup":true,"surveytype":"popup","fbsize":"small","fbanimate":false}},"icon":"aspark100.png","delay":0,"template":"default","label":"Feedback","fblocation":"middleright","fbtype":"badge","disabled":false,"fbanimate":true,"fbfixed":false,"fbdirection":"vertical","topics":[{"order":1,"id":"58279","answerId":"RIN0218052A001","topicText":"Click here to type new topic","whitelistActive":false,"whitelistData":[],"blacklistData":[],"blacklistActive":false}],"surveytype":"modal","replay":false,"fbcolor":"#000","saved":true,"datauri":"https://survey.foreseeresults.com/survey/published/display/json-view","posturi":"https://survey.foreseeresults.com/survey/jsonprocess","reporturi":"https://cxsuite.foresee.com/client/feedback-admin/projects/44686/analytics/summary","whitelistData":["*"],"blacklistActive":false,"blacklistData":[],"mid":"TWOsuXbba3kdNvnEHli4WiCC28TlJFzE","version":5},{"icon":"aspark100.png","delay":0,"template":"default","label":"Feedback","fblocation":"middleright","fbtype":"badge","disabled":true,"fbanimate":false,"fbfixed":false,"fbdirection":"vertical","topics":[{"order":1,"id":"18916","answerId":"RIN0147456A001","whitelistActive":false,"whitelistData":[""],"topicText":"Choose a topic"}],"surveytype":"modal","replay":false,"fbcolor":"#000","saved":true,"datauri":"https://survey.foreseeresults.com/survey/published/display/json-view","posturi":"https://survey.foreseeresults.com/survey/jsonprocess","reporturi":"https://cxsuite.foresee.com/client/feedback-admin/projects/12965/analytics/summary","mid":"3323G6MzCCD7wtZ0LDaUJZFvH9ZSg6AQ"}]};
...
productConfig.trigger = ({
  ...
  "check": function() {
    ...
    config = {
      version: "19.1.3",
      id: "38IrCegT58bxjLIUjbTzHw==",
      site_id: "havertys.com",
      surveyUrl: "https://survey.foreseeresults.com/survey/display",
      brain_url: "https://brain.foresee.com",
      persistence: "COOKIE",
      triggerDelay: 0,
      inviteDelay: 0,
      repeatDays: {
